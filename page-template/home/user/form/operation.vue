...
const { loadingCreate, state, refetchUserList } = useFormLogic();
...
<template>
  <a-form
    ...
    @finish="onFinish"
  >
    <a-form-item label="Username" name="name" :rules="[{ required: true }]">
    ...
    <a-form-item>
      <a-button type="primary" html-type="submit" :loading="loadingCreate"
        >Create</a-button
      >
    </a-form-item>
  </a-form>
